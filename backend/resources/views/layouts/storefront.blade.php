...
<head>
    ...
    <title>@yield('title', 'C-Net Store | Shopping, Grocery & Food Delivery')</title>
...
<header class="site-header">
    ...
    <div class="container nav-row">
        ...
        <nav class="actions"><a href="{{ route('login') }}">Account</a><a href="{{ route('cart') }}">Cart <span class="badge">0</span></a></nav>
    </div>
...
<footer class="footer"><div class="container footer-grid"><div><img class="footer-logo" src="{{ asset('images/cnet-store-logo.png') }}" alt="C-Net Store"><p>Your local marketplace for shopping, grocery and food delivery.</p></div><div><h3>Customer Care</h3><p><a href="tel:+917782801846">7782801846</a><br><a href="mailto:shekharnalanda@gmail.com">shekharnalanda@gmail.com</a></p></div><div><h3>Address</h3><p>C-Net Campus, Quamruddin Ganj,<br>Bihar Sharif, Nalanda – 803101</p></div></div><div class="copyright">© {{ date('Y') }} C-Net Store. All rights reserved.</div></footer>
</body>
</html>
