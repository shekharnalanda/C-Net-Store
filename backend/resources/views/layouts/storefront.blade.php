...
<footer class="footer"><div class="container footer-grid"><div><img class="footer-logo" src="{{ asset('images/cnet-store-logo.png') }}" alt="C-Net Store"><p>Your local marketplace for shopping, grocery and food delivery.</p></div><div><h3>Customer Care</h3><p><a href="tel:+917782801846">7782801846</a><br><a href="mailto:mcieducationalgroup@gmail.com">mcieducationalgroup@gmail.com</a></p></div><div><h3>Address</h3><p>MCI Campus, Quamruddin Ganj,<br>Bihar Sharif, Nalanda – 803101</p></div><div><h3>Policies</h3><p><a href="{{ route('pages.show','privacy-policy') }}">Privacy Policy</a><br><a href="{{ route('pages.show','terms-and-conditions') }}">Terms & Conditions</a><br><a href="{{ route('pages.show','cancellation-refund-policy') }}">Cancellation & Refund</a><br><a href="{{ route('pages.show','shipping-delivery-policy') }}">Shipping & Delivery</a><br><a href="{{ route('pages.show','seller-marketplace-terms') }}">Seller Terms</a></p></div></div><div class="copyright">© {{ date('Y') }} C-Net Store. All rights reserved.</div></footer>
