...
class SupportController extends Controller
{
    ...
    public function store(Request $request, CentralSyncService $centralSync): JsonResponse
    {
        ...
        $centralSync->enquiry([
            ...
            'source_reference_id' => 'store-support-'.$ticket->ticket_number,
            ...
            'category' => 'general',
            'course_service' => 'Store Support: '.$ticket->category,
            'metadata' => [
                'ticket_number' => $ticket->ticket_number,
                'order_id' => $ticket->order_id,
                'store_category' => $ticket->category,
            ],
        ]);
