...
{
    protected $fillable = ['order_number', 'user_id', 'business_id', 'outlet_id', 'address_id', 'status', 'fulfilment_type', 'subtotal', 'discount_total', 'tax_total', 'delivery_fee', 'platform_fee', 'grand_total', 'currency', 'customer_note', 'placed_at'];

    protected function casts(): array
    {
        return ['status' => OrderStatus::class, 'subtotal' => 'decimal:2', 'discount_total' => 'decimal:2', 'tax_total' => 'decimal:2', 'delivery_fee' => 'decimal:2', 'platform_fee' => 'decimal:2', 'grand_total' => 'decimal:2', 'placed_at' => 'datetime'];
    }
